...
class PaypalController extends Controller
{
    ...
    public function getPaymentStatus()
    {
        ...
        //clear the session payment getId
        ...
        if(empty($payerId) || empty($token)){
            return \Redirect::route('index')->with('message', 'Huvo un problema al intentar pagar con Paypal');
        }
        ...
        if($result->getState() == 'approved') {
            ...
            // redirect 
            return \Redirect::route('index')->with('message', 'Compra realizada de forma correcta');
        }
    ...
    protected function saveOrder()
    {
       ...
       foreach($cart as $producto)
       {
            $subtotal = $subtotal + ($producto->quantity * $producto->price);
       }
