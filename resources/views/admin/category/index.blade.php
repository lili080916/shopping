...
<div class="container text-center">
    <div class="page-header">
        <h1><i class="fa fa-shopping-cart"></i> CATEGORÍAS <a href="{{ route('category.create') }}" class="btn btn-warning"><i class="fa fa-plus-circle"></i>  Categoría</a> </h1>
    </div><br>
    <div class="page">
                ...
                <tbody>
                    @foreach($categories as $category)
                        <tr>
                           ...
                           <td>
                               {!! Form::open(['route'=>array('category.destroy', $category)]) !!}
