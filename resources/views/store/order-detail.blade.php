 ...
 <div class="container text-center">
    ...
    <div class="page">
        ...
        <div class="table-responsive">
            ...
            <p>
                <a class="btn btn-primary" href="{{ route('cart.show')}}"><i class="fa fa-chevron-circle-left"></i>Regresar</a>
                <a class="btn btn-warning" href="{{ route('payment') }}">Pagar con <i class="fab fa-paypal fa-2x"></i></a>
            </p>
        </div>
    </div>
</div>
